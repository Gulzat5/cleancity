...
# Импортируем Base, где содержатся все метаданные моделей
from app.models import Base  # Замените на путь к вашему файлу с моделями

# Это объект MetaData
target_metadata = Base.metadata  # Подключаем MetaData для Alembic
